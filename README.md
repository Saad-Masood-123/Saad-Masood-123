...
- 🔍 **AI Auditor** — Financial Anomaly Detection  
- 🤖 **Restaurant AI Chatbot** — LLM Automation with n8n  
- 💬 **Emotion-Aware Chatbot** — LoRA Fine-tuned Model  
- 👤 **Face Recognition System** — Attendance Tracking App  
- 📚 **Book Inventory System** — Full-Stack with SMTP  
- 🎬 **Celebrity Classifier** — Image Classification Pipeline  
- 🎵 **Music Player App** — Python Desktop App  
- 🔒 **OpenVPN GUI Manager** — VPN Controller Tool  
- ✍️ **Handwritten Digits Classifier** — CNN Model  
